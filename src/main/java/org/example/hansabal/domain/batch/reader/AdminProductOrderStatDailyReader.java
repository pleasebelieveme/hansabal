...
@Component
public class AdminProductOrderStatDailyReader implements ItemReader<ProductOrderStatDaily> {
	...
	public ProductOrderStatDaily read() {
		...
		if (dailyIterator == null) {
			...
			List<ProductOrderStatDaily> stats = dailyRepository.findAllByDateRange(from, to);
