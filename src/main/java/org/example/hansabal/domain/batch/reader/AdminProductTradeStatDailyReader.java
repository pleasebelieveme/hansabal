...
@Component
public class AdminProductTradeStatDailyReader implements ItemReader<ProductTradeStatDaily> {
	...
	public ProductTradeStatDaily read() {
		...
		if (dailyIterator == null) {
			...
			List<ProductTradeStatDaily> stats = dailyRepository.findAllByDateRange(from, to);
