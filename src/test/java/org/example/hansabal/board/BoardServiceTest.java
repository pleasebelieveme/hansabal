package org.example.hansabal.board;
...
public class BoardServiceTest {
    ...
    void 게시글_수정() {
        BoardRequest request = new BoardRequest("NOTICE", "수정 제목", "수정 내용");
        UserAuth userAuth = new UserAuth(1L, UserRole.USER);
    ...
    void 게시글_상세조회() {
        UserAuth userAuth = new UserAuth(1L, UserRole.USER);
        BoardResponse response = boardService.getPost(1L, PageRequest.of(0, 10));
    ...
    void 게시글_상세조회_예외() {
        assertThatThrownBy(() -> boardService.getPost(9999L, PageRequest.of(0, 10)))
                .isInstanceOf(BizException.class)
